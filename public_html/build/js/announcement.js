...
document.addEventListener("DOMContentLoaded", () => {
    const likeButtons = document.querySelectorAll('.reaction-trigger-btn');
    ...
    likeButtons.forEach((button) => {
        const popup = button.querySelector(".reaction-popup-menu");
        ...
        button.addEventListener("click", (e) => {
            ...
            if (e.target.closest('.reaction-popup-menu img')) return;

            popupVisible = !popupVisible;
            if (popup) popup.classList.toggle("show", popupVisible);
        });
    ...
    topIcons.forEach((icon) => {
        ...
        const popup = container.querySelector(".reaction-popup-menu");
