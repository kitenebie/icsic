...
<body class="bg-gray-100 min-h-screen flex items-center justify-center px-4">
  <div class="bg-white max-w-md w-full p-8 rounded-2xl shadow-xl text-center">
    <div class="mb-6">
      <svg class="mx-auto h-16 w-16 text-brown-500" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
    ...
    <p class="text-gray-700 mb-4">
      <strong>Reason:</strong>{{ App\Models\User::findOrFail(auth()->user()->id)->rejection_reason }}}}
    </p>
    ...
    <a href="https://mail.google.com/mail/?view=cm&fs=1&to=irosincentralschool01@gmail.com" class="inline-block bg-brown-600 text-white px-5 py-2 rounded-full hover:bg-brown-700 transition">
      Contact Support
    </a>
  </div>
</body>
