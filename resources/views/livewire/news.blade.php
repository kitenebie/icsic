<div>
    ...
    <x-filament::modal width="3xl" slide-over :close-by-clicking-away="false">
        ...
        <div>
            ...
            <div id="newsDraftSection" class="hidden bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-2">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-blue-600">You have unsaved news data</p>
                        </div>
                    </div>
                    <button type="button" id="restoreNewsDraftBtn"
    ...
    <script>
        // News Draft Functionality
        document.addEventListener('DOMContentLoaded', function() {
            const restoreBtn = document.getElementById('restoreNewsDraftBtn');
            const draftSection = document.getElementById('newsDraftSection');

            if (restoreBtn) {
                restoreBtn.addEventListener('click', function() {
                    const saved = localStorage.getItem('NewsDraft');
                    if (saved) {
                        try {
                            const data = JSON.parse(saved);
                            console.log('📂 Restoring news draft:', data);
                            ...
                            console.log('✅ News draft restored successfully');
                        } catch (error) {
                            console.error('❌ Error restoring news draft:', error);
