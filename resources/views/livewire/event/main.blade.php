...
<div>
    ...
    <x-filament::modal width="3xl" style="z-index: 99999;">
        ...
        <div id="eventsDraftSection" class="hidden bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-2">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-blue-600">You have unsaved event data</p>
                    </div>
                </div>
                <button type="button" id="restoreEventsDraftBtn"
    ...
    <script>
        ...
        // Event Draft Functionality
        document.addEventListener('DOMContentLoaded', function() {
            const restoreBtn = document.getElementById('restoreEventsDraftBtn');
            const draftSection = document.getElementById('eventsDraftSection');
    
            if (restoreBtn) {
                restoreBtn.addEventListener('click', function() {
                    const saved = localStorage.getItem('eventsDraft');
                    if (saved) {
                        try {
                            const data = JSON.parse(saved);
                            console.log('📂 Restoring event draft:', data);
                            ...
                            console.log('✅ Event draft restored successfully');
                        } catch (error) {
                            console.error('❌ Error restoring event draft:', error);
