            ...
            <div class="flex items-center justify-between p-6 border-b border-gray-200">
                <div class="flex items-center space-x-4">
                    <div class="flex items-center space-x-3">
                        <div
                            class="w-10 h-10 bg-grad-cream-brown-right rounded-lg flex items-center justify-center">
                    ...
                    <div class="flex items-center space-x-2">
                        <button id="prev"
                            class="p-2 hover:bg-brown-50 rounded-full transition-colors duration-200">
                    ...
                    <div class="relative">
                        <button id="monthYearSelector"
                            class="px-4 py-2 bg-white border border-gray-300 rounded-lg shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-brown-500 focus:border-brown-500 transition-colors duration-200 flex items-center space-x-2">
                        ...
                        <div id="monthYearDropdown"
                            ...
                            <div class="p-3 border-t border-gray-200 bg-gray-50 rounded-b-lg">
                                <button id="currentMonthBtn"
                                    class="w-full py-2 px-4 bg-brown-600 text-white text-sm font-medium rounded-md hover:bg-brown-700 transition-colors duration-200">
                                    Go to Current Month
                                </button>
                            </div>
                        </div>
        ...
        <div id="modal" class="fixed inset-0 hidden bg-black bg-opacity-50 flex items-center justify-center p-4"
            ...
            <div class="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-hidden">
                ...
                <div class="flex items-center justify-end p-6 border-t border-gray-200 bg-gray-50">
                    <button onclick="closeModal()"
                        class="px-6 py-2 bg-brown-600 text-white rounded-lg hover:bg-brown-700 transition-colors duration-200 font-medium">
                        Close
                    </button>
                </div>
            </div>
                        ...
                        @if ($event->event_images && count($event->event_images) > 0)
                            <div class="relative h-48 overflow-hidden">
                                <div
                                    ...
                                    @empty
                                        <div
                                            class="w-full h-full bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg flex items-center justify-center">
        ...
        @if ($events != null && count($events) > 0)
            <script>
                ...
                function executeAll() {
                    ...
                    // Google Calendar style color mapping with brown and cream theme
                    ...
                    window.renderCalendar = function(date) {
                        ...
                        for (let i = 1; i <= totalDays; i++) {
                            ...
                            if (hasEvent) {
                                ...
                                badge.className =
                                    "absolute top-2 right-2 sm:text-[12px]  bg-brown-500 text-white text-xs font-bold px-2 py-0.5 rounded-full z-[30]";
                        ...
                        eventsByCell.forEach((cellEvents, cellIndex) => {
                            ...
                            cellEvents.forEach(cellEvent => {
                                ...
                                spanBar.className =
                                    "dark:text-brown-200 dark:shadow-lg dark:shadow-brown-900/20";
