...
<div class="flex flex-col gap-6">
    ...
    <div id="draftSection" class="hidden bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
        ...
        <!-- Front ID -->
        <div>
            <label required for="front_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Front ID <span class="text-red-500">*</span></label>
        ...
        <!-- Back ID -->
        <div>
            <label for="back_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Back ID <span class="text-red-500">*</span></label>
            <input required type="file" name="back_id" id="back_id" accept="image/*"
                class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
        </div>
