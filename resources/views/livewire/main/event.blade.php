            ...
            @forelse ($events as $event)
                <div id="event-{{ \Carbon\Carbon::parse($event->event_date)->format('Y') }}{{ \Carbon\Carbon::parse($event->event_date)->format('M') }}"
                    ...
                    <div class="flex justify-between items-start mb-4">
                        <div class="bg-cream-100 rounded-md text-brown-600 font-semibold text-center w-14">
                        ...
                        <div class="bg-cream-600 text-brown-100 text-xs rounded-full px-3 py-1 font-semibold self-start">
